...
class _TutorialsState extends State<Tutorials> {
  ...
  final List<String> images = ['assets/images/tutorial-1.jpg','assets/images/tutorial-2.jpg','assets/images/tutorial-3.jpg'];
  final List<Color> colors = [Colors.brown.shade300,Colors.blueGrey.shade300,Colors.indigo.shade300];
  @override
          ...
          children: <Widget>[
            Swiper(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ItemTutorial(title: titles[index],subtitle: subtitles[index],bg: colors[index],image: images[index],);
              },
            ),
            Align(
              alignment: Alignment.bottomLeft,
              child: FlatButton(
                child: Text('ข้าม',style: TextStyle(color: Colors.white,fontSize: 17),),
                onPressed: (){
            ...
            Align(
              ...
              child: IconButton(
                icon: Icon(_currentIndex < _pageCount - 1? Icons.arrow_forward_ios : FontAwesomeIcons.check,color: Colors.white,),
                onPressed: (){
                  if(_currentIndex != 2) _controller.next();
                  else  Navigator.pushNamedAndRemoveUntil(context, UIdata.loginPageTag,
                      ModalRoute.withName(UIdata.loginPageTag));
                },
              )
            ),
