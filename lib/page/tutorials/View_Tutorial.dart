          ...
          children: <Widget>[
            Swiper(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ItemTutorial(title: titles[index],subtitle: subtitles[index],bg: colors[index],);
              },
            ),
            Align(
              alignment: Alignment.bottomLeft,
              child: FlatButton(
                child: Text('ข้าม',style: TextStyle(color: Colors.black,fontSize: 17),),
                onPressed: (){
            ...
            Align(
              ...
              child: IconButton(
                icon: Icon(_currentIndex < _pageCount - 1? Icons.arrow_forward_ios : FontAwesomeIcons.check,color: Colors.black,),
