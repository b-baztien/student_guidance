                   ...
                   child: Column(
                     ...
                     Container(
                       ...
                       child: Column(
                         children: <Widget>[
                           FutureBuilder(
                             future: GetImageService().getImage(_career.image),
                           ...
                           Text(_career.careerName,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 27,color: Colors.white)),
                         ],
                       ),
                     ),
                       Container(
                       ...
                       Text(_career.description,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.white)),
                     ],
                   ),
                    ),
                    SizedBox(height: 15),
                    Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          Text('สาขาเกี่ยวข้อง',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.white),)
                        ],
                      ),
                    )
                  ],
